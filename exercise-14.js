...
//9. Write a function that takes an array of numbers and returns a new array where each element is the square of the original element   
  ...
  let bigArray = bigNumber.filter((num)=> {
    return num > 5
  })
  ...
  //13. Write a function that takes an array of numbers and returns a new array that contains only the unique numbers.
   let bigNum = [1,2,3,1,6,7,2,3]
  let uni = new Set([...bigNum])
console.log([uni])
